...
define config.name = _("蓝色大肥鱼之「Context Error」")
...
define config.version = "0.1.0-prelude.1"
...
define gui.about = _p("""
Context Error: Prelude
v0.1.0-prelude.1

本系列仅供个人学习使用，禁止用于商业用途。
...
define build.name = "ContextErrorPrelude"
define build.version = "0.1.0-prelude.1"
define build.executable_name = "ContextError"
define build.directory_name = "ContextError-0.1.0-prelude.1"
...
define config.save_directory = "ContextError-Prelude"
