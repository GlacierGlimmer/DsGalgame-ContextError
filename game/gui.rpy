...
define gui.accent_color = '#69b7ff'

## 当文本按钮既未被选中也未被悬停时使用的颜色。
define gui.idle_color = '#8d98a5'

## 小的颜色用于小的文本，需要更亮/更暗才能达到同样的效果。
define gui.idle_small_color = '#5d6875'

## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#eef6ff'
...
## 当文本按钮无法被选择时使用的颜色。
define gui.insensitive_color = '#59616b88'
...
## 对话和菜单选择文本使用的颜色。
define gui.text_color = '#dde5ed'
define gui.interface_text_color = '#cbd4de'
...
define gui.choice_button_borders = Borders(26, 16, 26, 16)
define gui.choice_button_text_font = gui.text_font
define gui.choice_button_text_size = 28
define gui.choice_button_text_xalign = 0.5
define gui.choice_button_text_idle_color = '#c8d0d8'
...
init python:
    ...
    def small():
        ...
        ## 调整对话框的位置。
        ## 手机横屏也沿用桌面版 238px 底部对话框，避免文字落在背景框上方。
        gui.textbox_height = 238
        gui.name_xpos = 180
        gui.dialogue_xpos = 180
        gui.dialogue_width = 1560
